...
class Screen1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        toolbarHeight: kToolbarHeight + 20, // AppBar'ın yükseklik ayarı
...
class _ButtonListWidgetState extends State<ButtonListWidget> {
  ...
  List<String> buttonExplainTexts = [
    'Google, one of the worlds largest technology companies, is seeking Data Center Technician Apprentices to ensure the sustainability of its rapidly expanding data center infrastructure. This apprenticeship program is designed for individuals who are interested in data center operations, passionate about technology, and eager to learn. \n\nAs a Data Center Technician Apprentice, you will receive training on the functioning, maintenance, and troubleshooting processes of Googles data center infrastructure. Additionally, you will gain knowledge about security protocols and best practices for data center operations. ',
    'High school diploma or equivalent educational qualification. \nBasic understanding of computer hardware, networking, and data center concepts.\nStrong problem-solving skills and attention to detail.\nAbility to work effectively both independently and in a team.\nExcellent communication and interpersonal skills.\nWillingness to work in a physically demanding environment, including lifting heavy equipment.\nFlexibility to work in shifts and weekends as required.',
